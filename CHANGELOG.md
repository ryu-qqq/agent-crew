...
| 버전 | 날짜 | 요약 | 전체 기록 |
|---|---|---|---|
| v0.17.0 | 2026-06-28 | review-ledger 스킬 — proposal 초안 텍스트 제시를 ops-pilot `POST /api/feedback/review-proposal` 자동 적립으로 교체; HITL 선별 유지·draft 적립·approve는 사람이 (MINOR, 미검증) | [releases/v0.17.0.md](./releases/v0.17.0.md) |
