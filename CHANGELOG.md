...
| 버전 | 날짜 | 요약 | 전체 기록 |
|---|---|---|---|
| v0.15.0 | 2026-06-08 | pr-review-triage 스킬 — GitHub PR 리뷰를 gh CLI로 모아 코드와 대조해 판단, ✅수용/🔁반론/⏸보류/☑️해결로 분류한 액션 플랜 제시. 맹목 수용 금지·read-only HITL(수정·답글은 사람 승인 후) (MINOR, 미검증) | [releases/v0.15.0.md](./releases/v0.15.0.md) |
